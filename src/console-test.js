...
export const runConsoleTests = (app, logStatus = false, logStorage = false) => {
    ...
    // Uses monthIndex -> 8 is September
    app.projects[0].todos[1].dueDate = new Date(2026, 8, 17);
    ...
    app.projects[2].todos[1].dueDate = new Date(2026, 8, 22);
